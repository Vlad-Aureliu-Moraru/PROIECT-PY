...
class MainWindow(QtWidgets.QMainWindow):
    def _plot_approximation(self, num_points=200):
        ...
        original_func_values = [target_function(y) for y in y_values]

        # Calculate the Bernstein approximation values for each point
        # Using a list comprehension for efficiency here.
        bernstein_approx_values = [bnf.aprox_berstein_on_interval(target_function, y, n_degree, a, b) for y in y_values]
    ...
    def calculeaza_func(self):
        ...
        bnf.aprox_berstein_on_interval(target_function,punct,grad,self.interval_1,self.interval_2)
        print(f"real value {target_function(punct)}")
